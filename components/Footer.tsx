      ...
      >
        ...
        <div className="space-y-5 sm:col-span-2 md:col-span-1">
          ...
          <div className="flex gap-3">
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#d2c3c7] text-[#492e3b] transition-all hover:bg-[#492e3b] hover:text-white">
            ...
            {/* Facebook */}
            <a href="#" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#d2c3c7] text-[#492e3b] transition-all hover:bg-[#492e3b] hover:text-white">
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            {/* YouTube */}
            <a href="#" aria-label="YouTube" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#d2c3c7] text-[#492e3b] transition-all hover:bg-[#492e3b] hover:text-white">
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <a href="mailto:care@lethiacares.in" className="group flex items-center gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-[13px] leading-relaxed text-[#4e4448]">
                Mon – Sat: 10AM – 8PM<br />Sun: 11AM – 5PM
              </div>
            </div>
          </div>
        </div>
