      ...
      >
        ...
        <div className="space-y-5 sm:col-span-2 md:col-span-1">
          ...
          <div className="flex gap-3">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/c/lethiacares" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="btn-icon flex h-9 w-9 items-center justify-center rounded-full border border-[#d2c3c7] text-[#492e3b] hover:bg-[#492e3b] hover:text-white">
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
