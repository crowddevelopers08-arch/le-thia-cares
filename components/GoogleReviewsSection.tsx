    ...
    <section id="reviews" className="bg-[#f4f3f1] px-4 py-10 sm:px-6 md:px-[80px] md:py-14 lg:py-20 xl:py-24">
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <AnimateOnScroll animation="fade-up" delay={360} className="flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
          ...
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex w-full items-center justify-center gap-2 rounded-[0.5rem] bg-[#25D366] px-10 py-4 text-[12px] font-semibold tracking-[0.08em] text-white transition-opacity hover:opacity-90 sm:w-auto">
